package com.algorithms.geneticalgorithm;
 ...
 *
 * @author luolong
 * @date 2015-7-13    下午5:37:21
 */
public class GeneAlgorithm {

    private int[] v = {
            220, 208, 198, 192, 180, 180, 165, 162, 160, 158, 155, 130, 125, 122, 120, 118, 115, 110, 105, 101, 100,
            100, 98, 96, 95, 90, 88, 82, 80, 77, 75, 73, 72, 70, 69, 66, 65, 63, 60, 58, 56, 50, 30, 20, 15, 10, 8, 5,
            3, 1};// 物品价值
    private int[] b = {
            80, 82, 85, 70, 72, 70, 66, 50, 55, 25, 50, 55, 40, 48, 50, 32, 22, 60, 30, 32, 40, 38, 35, 32, 25, 28, 30,
            22, 50, 30, 45, 30, 60, 50, 20, 65, 20, 25, 30, 10, 20, 25, 15, 10, 10, 10, 4, 4, 2, 1};// 物品体积
     ...
     * @param m 变异率
     */
    public GeneAlgorithm(int s, int l, int g, float c, float m) {
        scale = s;
        LL = l;
        MAX_GEN = g;
        Pc = c;
    ...
    public static void main(String[] args) throws IOException {
        ...
        GeneAlgorithm ga = new GeneAlgorithm(20, 50, 500, 0.8f, 0.9f);
        ga.init();
        ga.solve();
    }
}
